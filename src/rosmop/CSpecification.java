...
public interface CSpecification {
    ...
    /**
     * A string containing the includes, or the preamble of the specification file.
    ...
    /**
     * A mapping from event names to Strings with the complete parameters of the events.
     * @return A mapping from event names to event parameters.
     */
    public HashMap<String, String> getParameters();
    
    /**
     * A mapping from event names to Strings with the parametric parameters of the events. These
     * are the complete parameters with an additional "void* key" parameter at the end.
     * @return A mapping from event names to parametric parameters.
     */
    public HashMap<String, String> getPParameters();
    
    /**
     * A mapping from logic state names to the action code to run on entering that state.
